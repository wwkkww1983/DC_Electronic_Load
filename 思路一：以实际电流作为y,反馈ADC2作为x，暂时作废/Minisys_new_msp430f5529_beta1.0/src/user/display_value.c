...
unsigned char back=0,chuan_dianliu_flag=0;//变量back用来判断界面1的次数
char dianliu[10]={};
char dianya[10]={};
char dianzu[10]={};
...
void display_value()
{
    if((jiemian==2)&&(confirm==1))//KEY3被第1次按下，并且进入2级界面
    {
        ...
        case 1:
            ...
            ssd1351_display_string(0, 80, "ADC2=", 1, White, Black);//显示反馈电压ADC2
            ssd1351_display_string(0, 100, "I=", 1, White, Black);//显示实际的电流值
            break;
        case 2:
        ...
        ssd1351_display_string(0,67,"Watch Window:",0,White,Black);
    ...
    else if((jiemian==2)&&(confirm==2))//参数确定按下一瞬间
    {
        ...
        //ssd1351_draw_h_line(0,38,127,White);
        get_ads1118_sample_voltage();//显示4通道采样得到的模拟电压
    }
